...
/* FILE UPLOADS */
$sysconf['max_upload'] = intval(ini_get('upload_max_filesize'))*150000;
$post_max_size = intval(ini_get('post_max_size'))*150000;
if ($sysconf['max_upload'] > $post_max_size) {
    $sysconf['max_upload'] = $post_max_size-150000;
}
$sysconf['max_image_upload'] = 2000;
